...
import achatService from '../../assets/images/achat-service.svg';
import './achat-service.style.scss';
function AchatService(){

    return(
       
        <section>
        <div class="mob-ressource">
        <h2>ACHAT DE SERVICES </h2>
            <div class="mob-ressource-content row">
                ...
                <div class="col-md-4" style={{ background: `url(${achatService})` }}>
