...
function AccueilPage(){
 ...
 const BarData= {
		labels: ["Etat", "Collectivités  territoriales", "Secteurs privés Sanitaires", "Secteurs privés non Sanitaires", "ONG et association", "PTF", "Société civile"],
		datasets : [{
			label: "Evolution Mobilisation Engagement pour le financement de la santé au senegal",
...
const labels2 = [
   ...
   <div>
    ...
    <div className="header-content row d-flex  align-items-center m-auto">
      <div className="col-md-8 col-sm-12 px-0">
        <p className="title fw-bold" style={{ fontSize:'2.5vh' }}>PLATEFORME NUMERIQUE DE SUIVI DU FINANCEMENT DE LA SANTE AU SENEGAL</p>
      </div>
 ...
 <div className="bg-white sticky-md-top ">
  <nav id="navbar-example2" className="navbar navbar-expand-lg navbar-light  bg-white   bg-body  max ">
    ...
    <div className="collapse navbar-collapse" id="navbarNav">
      <ul className="nav">
        <li className="nav-item ps-3 ">
          <a className="nav-link " href="#scrollspyAccueil">Accueil</a>
        </li>
        <li className="nav-item ps-3">
          <a className="nav-link" href="#scrollspyFinancement">Financement</a>
        </li>
        <li className="nav-item ps-3">
          <a className="nav-link" href="#scrollspyIndicateurs">Indicateurs</a>
        </li>
     </ul>
    </div>
    ...
    <div className=" ">
        ...
        <div className="row g-0">
          <div className="col-md-5 col-sm-12 bg-blue-img ">
            <div className="card-body text-light ms-5 ps-3 px-0 pt-5  max">
              ...
              <div className="pb-5">
                <a className="btn btn btn-sm bouton" href="#">EN SAVOIR PLUS</a>
              </div>
            </div>
          </div>
          <div className="col-md-7 col-sm-12 bg-image1">
      ...
      <div className="bg-grand-section">
        ...
        <div className="d-flex flex-column max pb-4">
          <p className="card-title text-blue fs-3 pt-5 col-md-9">Le Financement de la santé</p>
              ...
              <div className="col-md-8  ">
                <div className="card-body mb-5 p-0 pt-5  max">
                  <div className=" trick4 d-flex  justify-content-start mb-5  ">
                    <div> <img  className="icon-fin  pe-4 "
                        src={source} alt="" /></div>
                    <div className="d-flex flex-column">
                      <div  className="financement ps-3 pb-1">Mobilisation de
                        ressources</div>
                      <p className="ps-3 text-financement" >Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                  ...
                  <div className=" trick4 d-flex  justify-content-start mb-5    ">
                    ...
                    <div className="d-flex flex-column">
                      <div  className="ps-3 pb-1 financement-Mise-en-commun">Mise en commun des ressources</div>
                      <p className="ps-3 text-financement" >Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                        Necessitatibus, similique? Lorem ipsum dolor sit amet. Lorem ipsum dolor sit, amet consectetur
                  ...
                  <div className="  d-flex align-items-center justify-content-start   ">
                    <div> <img  className="icon-fin  pe-4 "
                        src={service} alt="" /></div>
                    <div className="d-flex flex-column">
                      <div  className="ps-3 financement">Achat des services
                      </div>
                      <p className="ps-3 text-financement" >Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                        Necessitatibus, similique? Lorem ipsum dolor sit amet Lorem ipsum dolor sit, amet consectetur
        ...
        <div className="d-flex flex-column max pb-5">
          <p className="card-title text-blue fs-4  pt-5 col-md-9">Le Volume du Financement de la santé par sources</p>
          <div className="divider-financement"></div>
        </div>
            ...
            <div  className="card   px-0 mb-3">
              <div  className="row  mx-auto g-0">
                <div className="col-md-2 text-light bg-blue">
                  <Link to="/mobilisation"><InfoIcon  className="icon-info" /></Link>
                <p className=" mob-mise-en-commun-achat text-white  ">MOBILISATION DES RESSOURCES</p>
                </div>
                <div className="col text-financement">
                  <div className="card-body">
                    <div className="d-flex justify-content-between align-items-center align-items-center">
                      ...
                      <p><img className="icon2" src="./Assets/icon/niv-execution.svg" alt="" /></p>
                    </div>
                ...
                <div className="col text-financement">
                  <div  className="card-body trait-vertical-gauche">
                    <div className="d-flex  justify-content-between align-items-center">
                      ...
                      <p><img className="icon2" src="./Assets/icon/engagement.svg" alt="" /></p>
                    </div>
                    ...
                    <div className="sous-ligne">
                      <p className="secteur">Collectivités Territoriales (CT)</p>
                    ...
                    <div className="sous-ligne">
                      <p className="secteur">Secteurs privés non Sanitaires</p>
                      <p  className="chiffres">100 000 000 F CFA</p>
                    </div>
                    <div className="sous-ligne">
                      <p className="secteur">Secteurs privés non Sanitaires</p>
                    ...
                    <div className="">
                      <p className="secteur">Partenaires Techniques Financiers (PTF)</p>
                ...
                <div className="col text-financement">
                  <div className="card-body trait-vertical-gauche trait-vertical-droite">
                    <div className="d-flex  justify-content-between align-items-center">
                      ...
                      <p><img className="icon2" src="./Assets/icon/mobilisation.svg" alt="" /></p>
                    </div>
                    <div className="sous-ligne">
                      <p className="secteur">Etat</p>
                      <p  className="chiffres">20 000 000 F CFA</p>
                ...
                <div className="col text-financement">
                  <div className="card-body">
                    <div className="d-flex  justify-content-between align-items-center">
                      ...
                      <p><img className="icon2" src="./Assets/icon/besoin.svg" alt="" /></p>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="progress mb-4 mt-4">
                        <div className="progress-bar " role="progressbar" style={{ width: '40%', backgroundColor: '#ff9100' }}
                          aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">40%</div>
                      </div>
                    </div>
                    <p className="card-text">Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui laborum aliquam,
        ...
        <div className="container-fluid max ">
          <div  className="row ">
            <div style={{ borderRadius: '15px !important' }}  className="card   px-0 mb-3">
              <div  className="row  mx-auto g-0">
                <div className="col-md-2 text-light bg-blue">
                  <p className="mob-mise-en-commun-achat text-white">MISE EN COMMUN DES RESSOURCES</p>
                ...
                <div className="col text-financement">
                  <div className="card-body">
                   ...
                   <div >
                     <div id="execution-mise-en-commun" style={{margin:'20px'}} >
                ...
                <div className="col text-financement">
                  <div className="card-body">
                    ...
                    <div>
                      ...
                      <div className="progress mb-4 mt-4">
                        <div className="progress-bar " role="progressbar" style={{ width: '80%', backgroundColor: 'green' }}
        ...
        <div className="container-fluid max ">
          <div  className="row ">
            <div style={{ borderRadius: '15px !important' }}  className="card    px-0 mb-3">
              <div  className="row  mx-auto g-0">
                <div className="col-md-2 text-light bg-blue">
                  <p className=" mob-mise-en-commun-achat text-white">ACHAT DE SERVICES</p>
                ...
                <div className="col text-financement">
                  <div className="card-body">
                   ...
                   <div >
                    <div id="execution-achat-service" style={{ margin:'20px' }}>
                ...
                <div className="col text-financement">
                  <div className="card-body">
                    ...
                    <div>
                      ...
                      <div className="progress mb-4 mt-4">
                        <div className="progress-bar " role="progressbar" style={{ width: '12%', backgroundColor: 'red' }}
         ...
         <div className="d-flex flex-column max pb-4">
          <p className="card-title text-blue fs-3  pt-5 col-md-9">Les indicateurs du financement de la Santé</p>
          <div className="divider-financement"></div>
        </div>
         <div className="card mb-5  max">
           <div className="card-body">
            <div style={{ height: '300px'}} /* className="max" */ id="chart-container">
              <div  id="barChart" style={{ height: '100%'}}><Bar data={BarData} options={chartOptions}/></div>
            </div>
           </div>
         </div>
        ...
        <div className="max row ">
         <div className="col ps-0">
          <div className="card mb-3">
            <div className="card-body">
             <div className="bande">
              <div className=" fw-bold  ps-2 pt-2 text-bande" > Etat</div>
             </div>
              <div className="text-center mt-3">12 000 000 000 F.CFA</div>
            <div>
              <div className="progress mt-4 height-progress  ">
                <div className="progress-bar orange-progress " role="progressbar" 
            ...
            <div>
              <div className="progress height-progress   mt-4">
                <div className="progress-bar vert-progress " role="progressbar" 
                  aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
              <div className="d-flex justify-content-between align-items-center">
         ...
         <div className="col ps-0">
          <div className="card mb-3" >
            <div className="card-body">
              <div className="bande">
                <div  className=" fw-bold text-bande ps-2  "> Collectivités Territoriales (CT)</div>
              </div>
              <div className="text-center mt-3">6 000 000 000 F.CFA</div>
            <div>
              <div className="progress height-progress   mt-4">
                <div className="progress-bar bleu-progress " role="progressbar" 
                  aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
              <div className="d-flex justify-content-between align-items-center">
                <div  className="mobilisation fw-bold">Mobilisation</div>
            ...
            <div>
              <div className="progress height-progress   mt-4">
                <div className="progress-bar vert-progress2 " role="progressbar" 
                  aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
              <div className="d-flex justify-content-between align-items-center">
                <div   className="mobilisation fw-bold">Engagement</div>
         ...
         <div className="col ps-0">
          <div className="card mb-3 " >
            <div className="card-body">
              <div className="bande">
                <div  className=" fw-bold text-bande ps-2 pt-2 "> Secteurs privés</div>
              </div>
              <div className="text-center mt-3">3 000 000 000 F.CFA</div>
            <div>
              <div className="progress height-progress   mt-4">
                <div className="progress-bar meuve-progress " role="progressbar"
                  aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
              <div className="d-flex justify-content-between align-items-center">
                <div  className="mobilisation fw-bold">Mobilisation</div>
            ...
            <div>
              <div className="progress height-progress   mt-4">
                <div className="progress-bar rouge-progress " role="progressbar" 
                  aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
              <div className="d-flex justify-content-between align-items-center">
                <div  className="mobilisation fw-bold">Engagement</div>
         ...
         <div className="col ps-0">
          <div className="card mb-3">
            <div className="card-body">
             <div className="bande">
              <div className=" fw-bold text-bande ps-2 pt-2 "> ONG et associations</div>
             </div>
              <div className="text-center mt-3"> 2 500 000 000 F.CFA</div>
            <div>
              <div className="progress height-progress  mt-4">
                <div className="progress-bar rose-progress " role="progressbar" 
                  aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
              <div className="d-flex justify-content-between align-items-center">
                <div style={{ color: '#6f96aa' }} className="mobilisation fw-bold">Mobilisation</div>
         ...
         <div className="col ps-0 pe-0">
          <div className="card mb-3" >
            <div className="card-body">
              <div className="bande">
                <div  className=" fw-bold text-bande ps-2"> Partenaires Techniques Financiers (PTF)</div>
              </div>
              <div className="text-center mt-3">9 600 000 000 F.CFA</div>
            <div>
              <div className="progress height-progress  mt-4">
                <div className="progress-bar rouge-progess2" role="progressbar"
                  aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
              <div className="d-flex justify-content-between align-items-center">
                <div className="mobilisation fw-bold">Mobilisation</div>
            ...
            <div>
              <div className="progress height-progress  mt-4">
                <div className="progress-bar jaune-progess " role="progressbar" 
                  aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
              <div className="d-flex justify-content-between align-items-center">
                <div  className="mobilisation fw-bold">Engagement</div>
...
<div className="col-md-4 ps-0">
 ...
 <div className="d-flex justify-content-between align-items-center">
  <div  className="mt-3 canvas">
    <div   id="myChart"><Doughnut data={doughnutData}/></div>
    </div>
...
<div className="ps-3 pe-3">
  <div id="myChart2" style={{height:'100%'}}><Line data={lineData} options={lineOptions}/></div>
</div>
  </div>
</div>
<div className="col-md-3 ps-0 pe-0">
  <div className="card mb-3 card-stat ">
    <p className="fw-bold mobilisation ps-3 pt-3">Statistique</p>
   <div className="">
    <div className="ps-3 pe-3" id="myChart3" width="" ><Bar  data={chartData2} options={chart2options}/></div>
   </div>
    <div className="d-flex justify-content-between align-items-center pt-4">
      <p className="fw-bold mobilisation ps-3">21 600 000 000 F.CFA</p>
