      ...
      <Col xs="12" sm="12">
        <Card className="card-border">
          ...
          <div style={{ paddingBottom: 30 }}>
            ...
            <Button /* class="close" data-dismiss="modal" aria-label="Close" */ color="primary" className="btn-pill pull-right" type="submit" style={{marginRight: '20px'}} disabled={pristine || submitting}>
               Save &nbsp;
