      ...
      <div className="wrapper">
        <div className="tab-wrapper">
          <ul className="tabs">
            ...
            <li className="tab-link" data-tab="5">
              Etat
            </li>
          </ul>
        </div>
                    ...
                    <div className="table-responsive">
                      <table className="table">
                        ...
                        <tbody>
                          {structures &&
                            structures
                              .filter((str) => str.source_financement === "ONG")
                              .map((structure) => (
                                <tr key={structure.id}>
                                  <td>{structure?.denomination}</td>
                                  <td> {structure?.source_financement} </td>
                                  <td>
                                    {structure.mobilisation_ressource ? (
                                    ...
                                    {structure.mis_en_commun_ressource ? (
                                      <span className="badge badge-primary mx-1">
                                        Mis en commun
                                      </span>
                                    ) : (
                                  ...
                                  <td>
                                    ...
                                    >
                                      <i
                                        className="mdi mdi-eye mdi-18px text-primary"
                                        onClick={() =>
                                          history.push(
                                            `/admin/structures/${structure.id}`
                                          )
                                        }
                                      ></i>
                                      <i
                                        className="mdi mdi-pencil mdi-18px text-primary "
                                        style={{ margin: "0px -15px" }}
                                        data-toggle="modal"
                                        data-target="#exampleModal"
                                        onClick={() =>
                                          props.getStructureById(structure.id)
                                        }
                                      ></i>
                                      <i
                                        className="mdi mdi-delete mdi-18px text-danger"
                                        onClick={() =>
                                          deleteStructure(
                                            structure.id,
                    ...
                    <div className="table-responsive">
                      <table className="table">
                        ...
                        <tbody>
                          {structures &&
                            structures
                              .filter((str) => str.source_financement === "PTF")
                              .map((structure) => (
                                <tr key={structure.id}>
                                  <td>{structure?.denomination}</td>
                                  <td> {structure?.source_financement} </td>
                    ...
                    <div className="table-responsive">
                      <table className="table">
                        ...
                        <tbody>
                          {structures &&
                            structures
                              .filter((str) => str.source_financement === "EPS")
                              .map((structure) => (
                                <tr key={structure.id}>
                                  <td>{structure?.denomination}</td>
                                  <td> {structure?.source_financement} </td>
                    ...
                    <div className="table-responsive">
                      <table className="table">
                        ...
                        <tbody>
                          {structures &&
                            structures
                              .filter((str) => str.source_financement === "SPS")
                              .map((structure) => (
                                <tr key={structure.id}>
                                  <td>{structure?.denomination}</td>
                                  <td> {structure?.source_financement} </td>
                      ...
                      <table className="table">
                        ...
                        <tbody>
                          {structures &&
                            structures
                              .filter(
                                (str) => str.source_financement === "Etat"
                              )
                              .map((structure) => (
                                <tr key={structure.id}>
                                  <td>{structure?.denomination}</td>
