...
function DistricteForm(props) {
    ...
    const {editedDistricte,initDistricteList, resetDistricte, 
          ...
          initRegionList, getCollectiviteByParentCode,
            ...
            <div class="modal-dialog" role="document">
                ...
                <div className="row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select class="form-control" data-actions-box="true" data-live-search="true" {...register("region")} id="region">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select class="form-control" data-actions-box="true" data-live-search="true" {...register("departement")} id="departement">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select class="form-control" data-actions-box="true" data-live-search="true" {...register("commune")} id="commune">
                                {communes?.map(region=>(
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <select class="form-control" data-actions-box="true" data-live-search="true" {...register("quartier")} id="quartier">
